...
import cz.shroomware.diorama.editor.ui.BackgroundLabel;
import cz.shroomware.diorama.editor.ui.DFLabel;
import cz.shroomware.diorama.editor.ui.NewProjectDialog;
...
public class ProjectSelectionScreen implements Screen {
    ...
    private final BackgroundLabel createProjectLabel;
...
//        scrollPane.pack();
    ...
    public abstract static class Item extends HorizontalGroup {
        ...
        private final Drawable backgroundPressed;
        private final DFLabel label;
