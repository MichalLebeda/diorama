...
public abstract class BaseLevelScreen implements Screen, InputProcessor {
    protected cz.michallebeda.diorama.engine.level.Level level;
    ...
    protected BaseLevelScreen(cz.michallebeda.diorama.engine.level.Resources resources, cz.michallebeda.diorama.engine.level.Level level) {
        this.level = level;
    ...
    protected void updateBackgroundColor(Resources resources, cz.michallebeda.diorama.engine.level.Level level) {
...
//        backgroundColor.mul(0.9f);
    ...
    public void render(float delta) {
        ...
        if (cz.michallebeda.diorama.Utils.SSAO) {
            fbo.begin();
            Gdx.gl.glClearColor(backgroundColor.r, backgroundColor.g, backgroundColor.b, 1);
