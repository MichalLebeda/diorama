...
public class Tile extends Sprite {
    ...
    protected cz.michallebeda.diorama.engine.level.object.GameObject attachedGameObject;
...
//            setColor(Color.ORANGE);
    ...
    public void attachObject(cz.michallebeda.diorama.engine.level.object.GameObject attachedDecal) {
    ...
    public boolean hasAttachedObjectOfPrototypeName(String name) {
        if (!hasAttachedObject()) {
            return false;
        }

        return name.equals(attachedGameObject.getPrototype().getName());
    }
