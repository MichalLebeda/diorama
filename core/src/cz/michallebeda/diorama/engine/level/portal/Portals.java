...
public class Portals {
    ...
    HashMap<cz.michallebeda.diorama.engine.level.portal.MetaPortal, Portal> metaToPortal = new HashMap<>();
    ...
    public Portals(MetaLevel metaLevel,
        ...
        Collection<cz.michallebeda.diorama.engine.level.portal.MetaPortal> values = metaPortals.getValues();
        for (cz.michallebeda.diorama.engine.level.portal.MetaPortal metaPortal : values) {
            add(new Portal(portalConnector, metaPortal, boxFactory, resources));
        }
    }

    public void setIgnored(cz.michallebeda.diorama.engine.level.portal.MetaPortal metaPortal) {
