package cz.michallebeda.diorama;
...
public class Utils {
    ...
    public static Array<cz.michallebeda.diorama.engine.ObjectShadowPair> atlasRegionToObjectShadowPair(Array<TextureAtlas.AtlasRegion> regions) {
        Array<cz.michallebeda.diorama.engine.ObjectShadowPair> pairs = new Array<>(cz.michallebeda.diorama.engine.ObjectShadowPair.class);
